...
const routes: Routes = [
  ...
  { path: 'encomendas/:id', loadChildren: () => import('./pages/encomendas/encomendas.module').then(m => m.EncomendasModule), canActivate:[AutenticacaoGuard] },
  { path: 'cad-encomendas/:id', loadChildren: () => import('./pages/cad-encomendas/cad-encomendas.module').then(m => m.CadEncomendasModule), canActivate:[AutenticacaoGuard] },
